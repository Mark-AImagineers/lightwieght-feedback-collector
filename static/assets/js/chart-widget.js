(function ($) {
  ...
  var optionslinechart = {
    ...
    colors: [yuriAdminConfig.primary],
    series: [
      {
  ...
  var optionslinechart2 = {
    ...
    colors: [yuriAdminConfig.secondary],
    series: [
      {
        name: "series1",
        data: [70, 60, 82, 80, 60, 90, 70, 120, 50, 60, 0],
  ...
  var optionscolumnchart = {
    ...
    colors: [yuriAdminConfig.secondary, "#83BF6E", yuriAdminConfig.primary],
    fill: {
      type: "gradient",
      gradient: {
        shade: "light",
  ...
  var optionsproductchart = {
    ...
    fill: {
      colors: [yuriAdminConfig.primary, yuriAdminConfig.secondary],
      type: "gradient",
      gradient: {
        shade: "light",
        type: "vertical",
      ...
      xaxis: [
        {
          ...
          strokeDashArray: 0,
          borderColor: yuriAdminConfig.primary,
          label: {
            borderColor: yuriAdminConfig.primary,
            offsetY: 20,
            style: {
              color: "#fff",
              background: yuriAdminConfig.primary,
            },
            text: "Anno Test",
          },
        },
  ...
  var optionsCircle = {
    ...
    colors: [yuriAdminConfig.secondary, yuriAdminConfig.primary, "#83BF6E"],
    responsive: [
      {
        breakpoint: 767,
        options: {
  ...
  var optionsProgress1 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "15%",
        colors: {
          backgroundBarColors: [yuriAdminConfig.primary],
    ...
    fill: {
      ...
      type: "gradient",
      gradient: {
        gradientToColors: [yuriAdminConfig.primary],
      },
    },
    series: [
      {
  ...
  var optionsProgress2 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "15%",
        colors: {
          backgroundBarColors: [yuriAdminConfig.secondary],
          backgroundBarOpacity: 0.2,
    ...
    fill: {
      ...
      gradient: {
        inverseColors: false,
        gradientToColors: [yuriAdminConfig.secondary],
      },
    },
    responsive: [
      {

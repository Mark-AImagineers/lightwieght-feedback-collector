(function ($) {
  ...
  $(".page-wrapper").attr(
    "class",
    "page-wrapper " + localStorage.getItem("page-wrapper-yuri")
  );
  if (localStorage.getItem("page-wrapper-yuri") === null) {
  ...
  if (menuWrapperSize >= "1660") {
    ...
    var sliderLimit = -3345;
  } else {
    var sliderLimit = -3200;
  }
  ...
  $(document).ready(function() {
    if (
      $(".simplebar-wrapper .simplebar-content-wrapper").length > 0 &&
      ...
      if (activeLink.length > 0) {
        // Animate scrolling to the active link
